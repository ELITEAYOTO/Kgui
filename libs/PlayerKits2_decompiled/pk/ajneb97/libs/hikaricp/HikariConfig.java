...
import pk.ajneb97.libs.hikaricp.HikariConfigMXBean;
import pk.ajneb97.libs.hikaricp.metrics.MetricsTrackerFactory;
import pk.ajneb97.libs.hikaricp.util.PropertyElf;
...
implements HikariConfigMXBean {
    ...
    private static final long SOFT_TIMEOUT_FLOOR = Long.getLong("pk.ajneb97.libs.hikaricp.timeoutMs.floor", 250L);
    ...
    private String generatePoolName() {
        ...
        try {
            ...
            synchronized (properties) {
                String next = String.valueOf(Integer.getInteger("pk.ajneb97.libs.hikaricp.pool_number", 0) + 1);
                System.setProperty("pk.ajneb97.libs.hikaricp.pool_number", next);
