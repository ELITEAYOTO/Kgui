...
import pk.ajneb97.libs.hikaricp.HikariConfig;
import pk.ajneb97.libs.hikaricp.HikariPoolMXBean;
import pk.ajneb97.libs.hikaricp.metrics.MetricsTrackerFactory;
import pk.ajneb97.libs.hikaricp.metrics.PoolStats;
import pk.ajneb97.libs.hikaricp.metrics.dropwizard.CodahaleHealthChecker;
import pk.ajneb97.libs.hikaricp.metrics.dropwizard.CodahaleMetricsTrackerFactory;
import pk.ajneb97.libs.hikaricp.metrics.micrometer.MicrometerMetricsTrackerFactory;
import pk.ajneb97.libs.hikaricp.pool.PoolBase;
import pk.ajneb97.libs.hikaricp.pool.PoolEntry;
import pk.ajneb97.libs.hikaricp.pool.ProxyConnection;
import pk.ajneb97.libs.hikaricp.pool.ProxyLeakTaskFactory;
import pk.ajneb97.libs.hikaricp.util.ClockSource;
import pk.ajneb97.libs.hikaricp.util.ConcurrentBag;
import pk.ajneb97.libs.hikaricp.util.SuspendResumeLock;
import pk.ajneb97.libs.hikaricp.util.UtilityElf;
...
ConcurrentBag.IBagStateListener {
    ...
    private final long aliveBypassWindowMs = Long.getLong("pk.ajneb97.libs.hikaricp.aliveBypassWindowMs", TimeUnit.MILLISECONDS.toMillis(500L));
    private final long housekeepingPeriodMs = Long.getLong("pk.ajneb97.libs.hikaricp.housekeeping.periodMs", TimeUnit.SECONDS.toMillis(30L));
    ...
    public HikariPool(HikariConfig config) {
        ...
        if (Boolean.getBoolean("pk.ajneb97.libs.hikaricp.blockUntilFilled") && config.getInitializationFailTimeout() > 1L) {
